...
npr = np.random
# face的id对应label的txt
anno_file = '/mnt/data/changshuang/data/wider_face_train.txt'
# 图片地址
im_dir = '/mnt/data/changshuang/data/WIDER_train/images'
# pos,part,neg裁剪图片放置位置
pos_save_dir = '/mnt/data/changshuang/data/12/positive'
part_save_dir = '/mnt/data/changshuang/data/12/part'
neg_save_dir = '/mnt/data/changshuang/data/12/negative'
# PNet数据地址
save_dir = '/mnt/data/changshuang/data/12'
